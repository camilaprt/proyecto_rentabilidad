    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex ">
            <div class="relative flex-grow focus-within:text-purple-500 mr-4">
                ...
                <input wire:model.live.debounce.300ms="search" class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" type="text" placeholder="Search for projects" aria-label="Search">
            </div>
            <a href="{{ route('crearfactura', ['tipo' => 'Compra']) }}"
