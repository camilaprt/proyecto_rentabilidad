<div>
    ...
    <div class="flex justify-between items-center">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Ventas</h2>
        <div class="flex ">
    ...
    <div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-xl sm:mx-4 sm:rounded-xl mx-auto z-50 relative">
                <!-- Título -->
                <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Eliminar Venta</h3>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody
                    class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">@foreach($ventas as $venta)
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <!--BOTON EDITAR -->
                                <button
                                    wire:click="editarVenta({{$venta->id}},'{{$venta->tipo_factura->tipo}}')"
