<div>
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button wire:click="abrirModalEditar" class="px-3 py-1 text-xs font-medium text-purple-600 border border-purple-600 rounded hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-300">Editar</button>
