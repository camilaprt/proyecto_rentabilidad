<div>
    ...
    <div class="flex justify-between items-center">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Proveedores</h2>
    ...
    <div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-xl sm:mx-4 sm:rounded-xl mx-auto z-50 relative">
                <!-- Título -->
                <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Eliminar Proveedor</h3>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody
                    class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">@foreach($proveedores as $proveedor)
