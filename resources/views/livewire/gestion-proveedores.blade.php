<div>
    ...
    <div class="flex justify-between items-center">
        <h2 class="my-6 text-2xl font-semibold text-gray-700">Proveedores</h2>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-xl sm:mx-4 sm:rounded-xl mx-auto z-50 relative">
                <h3 class="text-xl font-semibold text-gray-700 mb-4">
                    @if($modalCrear) Nuevo Proveedor @else Editar Proveedor @endif
                </h3>

                <form wire:submit.prevent="{{$modalCrear ? 'guardarProveedor' : 'actualizarProveedor'}}">
    ...
    <div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-xl sm:mx-4 sm:rounded-xl mx-auto z-50 relative">
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Eliminar Proveedor</h3>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                ...
                                <button
                                    ...
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg focus:outline-none focus:shadow-outline"
                                    aria-label="Edit">
                                ...
                                <!--BOTON ELIMINAR -->
                                <button
                                    wire:click="abrirModalEliminar({{$proveedor->id}})"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg focus:outline-none focus:shadow-outline"
                                    aria-label="Delete">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
